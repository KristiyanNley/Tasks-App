...
//        Log.d(TAG, "onBindViewHolder: starts");
        ...
        if((mCursor == null) || (mCursor.getCount() == 0)) {
            ...
            holder.name.setText(R.string.instructions_headinng);
            ...
            @SuppressLint("Range") final Task task = new Task(mCursor.getLong(mCursor.getColumnIndex(TasksContract.Columns._ID)),
